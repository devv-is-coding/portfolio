...
const viewAllProjects = () => {
    fetch('http://localhost:3000/view-all-projects', { method: 'GET' }) 
        .then(response => response.json())
        .then(data => {
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text2">Project Created: Date: ${formattedDate || 'No information available.'} Time: ${formattedTime || 'No information available.'}</p>
                            </div>
                        </div>
                    </div>
                `;
